...
from modules.persons.infrastructure.serializers.django import UserSerializer as DjangoUserSerializer
from modules.persons.application.all import AllUsers as AllUsersService
